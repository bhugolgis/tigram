...
class Form2 extends StatefulWidget {
  ...
  String IdProof;
  List log_details;
  Form2({this.sessionToken,this.dropdownValue,this.dropdownValue1,this.userName,this.userEmail,this.Name,this.Address,this.survey_no,this.Tree_Proposed_to_cut,this.village,this.Taluka,this.block,this.District,this.Pincode,this.Ownership,this.Purpose,this.holder_1,this.Application,this.Approval,this.Declaration,this.Location,this.TreeOwnership,this.IdProof,this.log_details});
  @override
  _Form2State createState() => _Form2State(sessionToken,dropdownValue,dropdownValue1,userName,userEmail,Name,Address,survey_no,Tree_Proposed_to_cut,village,Taluka,block,District,Pincode,Ownership,Purpose,holder_1,Application,Approval,Declaration,Location,TreeOwnership,IdProof,log_details);
}
...
class _Form2State extends State<Form2> {
  ...
  String IdProof;
  List log_details;
  _Form2State(this.sessionToken,this.dropdownValue,this.dropdownValue1,this.userName,this.userEmail,this.Name,this.Address,this.survey_no,this.Tree_Proposed_to_cut,this.village,this.Taluka,this.block,this.District,this.Pincode,this.Ownership,this.Purpose,this.holder_1,this.Application,this.Approval,this.Declaration,this.Location,this.TreeOwnership,this.IdProof,this.log_details);
                          ...
                          onPressed: () async {
                            ...
                            ||(destination_add.text.length==0)||(Ownership==null)||(Application==null)||(TreeOwnership==null)){
                             ...
                             setState(() {
                              ...
                              final String url = 'http://13.235.67.23:8000/api/auth/InsertRecord';
                              Map data = {
                                "name": Name,
                                "address": Address,
                                "survey_no": survey_no,
                                ...
                                "log_details": log_details==null?"":log_details
