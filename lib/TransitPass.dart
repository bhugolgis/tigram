...
class TransitPass extends StatefulWidget {
  ...
  String userName ;
  String userEmail;
  TransitPass({this.sessionToken,this.userName,this.userEmail});
  @override
  _TransitPassState createState() => _TransitPassState(sessionToken,userName,userEmail);
}
...
class _TransitPassState extends State<TransitPass> {
  ...
  String userName ;
  String userEmail;
  _TransitPassState(this.sessionToken,this.userName,this.userEmail);
  //-----------------Controller----------------------------
  ...
  LoadTaluka() async {
    ...
    Map data = {
      "district": selectedDistrict==null?"":selectedDistrict,
    };
    print(data);
  ...
  LoadVillage() async {
    ...
    Map data = {
      "taluka":selectedTaluka==null?"":selectedTaluka
    };
    print(data);
    var body = json.encode(data);
    print(body);
