import 'dart:convert';
import 'package:Tigram/DivisionReport.dart';
...
class DivisonDashBoard extends StatefulWidget {
  ...
  DivisonDashBoard({this.userId,this.userName,this.userEmail,this.sessionToken,this.userGroup,this.dropdownValue,this.userRange});
  @override
  _DivisonDashBoardState createState() => _DivisonDashBoardState(userId,userName,userEmail,sessionToken,userGroup,dropdownValue,userRange);
}
...
class _DivisonDashBoardState extends State<DivisonDashBoard> {
  ...
  _DivisonDashBoardState(this.userId,this.userName,this.userEmail,this.sessionToken,this.userGroup,this.dropdownValue,this.userRange);
  double Approved=0;
  double Rejected=0;
  double Pending=0;
  void initState()  {
...
//------------------End--Pie--Chart--------------
  ...
  String url="http://13.235.67.23:8000/api/auth/new_transit_pass_pdf/90/";
...
//-----------Approved------------------------
  ...
  void PendingApp() async {
    ...
    //---------------clear---------------
    final String url = 'http://13.235.67.23:8000/api/auth/DfoPendingListViewApplication';
    Map data = {
      "area_range":SelectedRange=="All Range"?"":SelectedRange==null?"":SelectedRange,
    };
...
//-----------Approved-------------
  void ApprovedApp() async {
    ...
    //----------clear-----------
    final String url = 'http://13.235.67.23:8000/api/auth/DfoApprovedListViewApplication';
    Map data = {
      "area_range":SelectedRange=="All Range"?"":SelectedRange==null?"":SelectedRange,
    };
    var body = json.encode(data);
                                        ...
                                        sr// Loops through dataColumnText, each iteration assigning the value to element
                                          ...
                                          ((value) => DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text(Tp_Number[int.parse(value)].toString()=='0'?"Not Generated":daysBetween(DateTime.parse(Tp_Issue_Date[int.parse(value)].toString())).toString())),
                                              DataCell(Text((Tp_Number[int.parse(value)].toString()=='0'?"N/A":Approved_date[int.parse(value)].toString()))),
                                              DataCell(
                                                new Visibility(
                                              ...
                                              DataCell(Text(OfficerDate(Current_status[int.parse(value)],verify_office_date[int.parse(value)] ,division_date[int.parse(value)],range_officer_date[int.parse(value)], deputy_officer_date[int.parse(value)], verify_office_date[int.parse(value)]))),
                                            ],
                                          )),
                                        ).toList(),
                                      )
                                        ...
                                        sr1// Loops through dataColumnText, each iteration assigning the value to element
                                          ...
                                          ((value) => DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text(OfficerStatus(division1[int.parse(value)],verify_range1[int.parse(value)], depty_range_officer1[int.parse(value)], verify_range_officer1[int.parse(value)],Current_status1[int.parse(value)].toString(),other_State1[int.parse(value)],verify_deputy2_1[int.parse(value)],log_updated_by_use1[int.parse(value)],verify_forest1_1[int.parse(value)]))),
                                              ...
                                              DataCell(Text(Tp_Number1[int.parse(value)].toString()=='0'?"N/A":Approved_date1[int.parse(value)].toString())),
                                              DataCell(
                                                new Visibility(
                                              ...
                                              DataCell(Text(OfficerRemark(Current_status1[int.parse(value)], disapproved_reason1[int.parse(value)],reason_division1[int.parse(value)], reason_range_officer1[int.parse(value)], reason_depty_ranger_office1[int.parse(value)], reason_office1[int.parse(value)]))),
                                              DataCell(Text(OfficerDate(Current_status1[int.parse(value)],verify_office_date1[int.parse(value)] ,division_date1[int.parse(value)],range_officer_date1[int.parse(value)], deputy_officer_date1[int.parse(value)], verify_office_date1[int.parse(value)]))),
                                            ],
                                          )),
                                        ).toList(),
                                      )
                                        ...
                                        sr2// Loops through dataColumnText, each iteration assigning the value to element
                                          ...
                                          ((value) => DataRow(
                                            cells: <DataCell>[
                                              ...
                                              DataCell(Text(OfficerRemark(Current_status2[int.parse(value)], disapproved_reason2[int.parse(value)],reason_division2[int.parse(value)], reason_range_officer2[int.parse(value)], reason_depty_ranger_office2[int.parse(value)], reason_office2[int.parse(value)]))),
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                          context,MaterialPageRoute(builder: (_) => DivisionReport(sessionToken:sessionToken,userRange:userRange))
                      );
                    }
                ),
                ListTile(
